/***************************************************************************************************
 * Author: 	BANQUERO, Juan Manuel
 * Subject: Laboratorio de computación III
 * Description:
...
/********************************************************************************************************
 * Function: JSON Array Filters.
 ********************************************************************************************************/
 const returnMovieTitle = (watchlist) => {
    return watchlist.filter((f)=>f.Director=='Christopher Nolan' && f.imdbRating>8.0).map((m)=>m.Title);
}
